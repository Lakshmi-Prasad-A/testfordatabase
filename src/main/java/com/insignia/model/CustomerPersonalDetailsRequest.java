...
public class CustomerPersonalDetailsRequest {
	...
	public String toString() {
		return "CustomerPersonalDetailsRequest [sequenceNumber=" + sequenceNumber + ", customerSequenceNumber="
				+ customerSequenceNumber + ", firstName=" + firstName + ", isFirstNameUpdated=" + isFirstNameUpdated
				+ ", lastName=" + lastName + ", isLastNameUpdated=" + isLastNameUpdated + ", middleName=" + middleName
				+ ", isMiddleNameUpdated=" + isMiddleNameUpdated + ", age=" + age + ", isAgeUpdated=" + isAgeUpdated
				+ ", gender=" + gender + ", isGenderUpdated=" + isGenderUpdated + ", customerEmailId=" + customerEmailId
				...
				+ ", getCustomerSequenceNumber()=" + getCustomerSequenceNumber() + ", getSequenceNumber()="
				+ getSequenceNumber() + ", getFirstName()=" + getFirstName() + ", isFirstNameUpdated()="
				+ isFirstNameUpdated() + ", getLastName()=" + getLastName() + ", isLastNameUpdated()="
				+ isLastNameUpdated() + ", getMiddleName()=" + getMiddleName() + ", isMiddleNameUpdated()="
				+ isMiddleNameUpdated() + ", getAge()=" + getAge() + ", isAgeUpdated()=" + isAgeUpdated()
				+ ", getGender()=" + getGender() + ", isGenderUpdated()=" + isGenderUpdated()
				+ ", getCustomerEmailId()=" + getCustomerEmailId() + ", isCustomerEmailIdUpdated()="
				+ isCustomerEmailIdUpdated() + ", getAlternativeEmailId()=" + getAlternativeEmailId()
				+ ", isAlternativeEmailIdUpdated()=" + isAlternativeEmailIdUpdated() + ", getCustomerMobileNumber()="
				+ getCustomerMobileNumber() + ", isCustomerMobileNumberUpdated()=" + isCustomerMobileNumberUpdated()
				+ ", getAlternativeMobileNumber()=" + getAlternativeMobileNumber()
				+ ", isAlternativeMobileNumberUpdated()=" + isAlternativeMobileNumberUpdated()
				+ ", getCustomerLandlineNumber()=" + getCustomerLandlineNumber() + ", isCustomerLandlineUpdated()="
				+ isCustomerLandlineUpdated() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
