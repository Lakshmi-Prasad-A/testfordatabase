...
public class RolesAndPermissionsRequest {
	...
	public String toString() {
		return "RolesAndPermissionsRequest [roleId=" + roleId + ", customer_sequence_number=" + customerSequenceNumber
				+ ", roleName=" + roleName + ", isRoleNameUpdated=" + isRoleNameUpdated + ", permission1=" + permission1
				+ ", isPermission1Updated=" + isPermission1Updated + ", permission2=" + permission2
				+ ", isPermission2Updated=" + isPermission2Updated + ", permission3=" + permission3
				+ ", isPermission3Updated=" + isPermission3Updated + ", permission4=" + permission4
				...
				+ isUpdatedPermissionsUpdated + ", getRoleId()=" + getRoleId() + ", getCustomer_sequence_number()="
				+ getCustomerSequenceNumber() + ", getRoleName()=" + getRoleName() + ", isRoleNameUpdated()="
				+ isRoleNameUpdated() + ", getPermission1()=" + getPermission1() + ", isPermission1Updated()="
				+ isPermission1Updated() + ", getPermission2()=" + getPermission2() + ", isPermission2Updated()="
				+ isPermission2Updated() + ", getPermission3()=" + getPermission3() + ", isPermission3Updated()="
				+ isPermission3Updated() + ", getPermission4()=" + getPermission4() + ", isPermission4Updated()="
				+ isPermission4Updated() + ", getRoleApprovedDate()=" + getRoleApprovedDate()
				+ ", isRoleApprovedDateUpdated()=" + isRoleApprovedDateUpdated() + ", getRoleRevokedDate()="
				+ getRoleRevokedDate() + ", isRoleRevokedDateUpdated()=" + isRoleRevokedDateUpdated()
				+ ", getPermissionChangeDate()=" + getPermissionChangeDate() + ", isPermissionChangeDateUpdated()="
				+ isPermissionChangeDateUpdated() + ", getUpdatedPermissions()=" + getUpdatedPermissions()
				+ ", isUpdatedPermissionsUpdated()=" + isUpdatedPermissionsUpdated() + ", getClass()=" + getClass()
